...
from myapp.application.ports.api.command.vote_for_article_command import VoteForArticleCommand
from myapp.application.domain.model.vote_for_article_result import (
    SuccessfullyVotedResult,
    VoteForArticleResult
)
from myapp.application.ports.spi.find_voting_user_port import (
    FindVotingUserPort
)
from myapp.application.ports.spi.save_voting_user_port import (
    SaveVotingUserPort
)
